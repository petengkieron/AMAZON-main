# Generated by Django 5.1.3 on 2025-01-17 23:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['name', 'category'], name='app_product_name_8a19ea_idx')],
            },
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('numero', models.CharField(max_length=15, null=True, unique=True, validators=[django.core.validators.RegexValidator(regex='^\\+?1?\\d{9,15}$')])),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'indexes': [models.Index(fields=['prenom', 'nom'], name='app_user_prenom_799d8b_idx'), models.Index(fields=['numero'], name='app_user_numero_c5c5a6_idx')],
            },
            managers=[
